...
import com.cyrex.runningapp.other.Constants.FASTEST_LOCATION_INTERVAL
import com.cyrex.runningapp.other.Constants.LOCATION_UPDATE_INTERVAL
...
import com.cyrex.runningapp.other.Constants.TIMER_UPDATE_INTERVAL
            ...
            if (isTracking.value!!) {
                result?.locations?.let { locations ->
                    for (location in locations) {
                        ...
                        Timber.d("NOW LOCATION: ${location.latitude}, ${location.longitude}")
                    }
                }
            }
        }
